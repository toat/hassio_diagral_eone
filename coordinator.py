"""DataUpdateCoordinator for eone."""
...
from custom_components.eone.api.models import Measure

from .api.client import EOneApiClient
...
class EOneCoordinatorData(NamedTuple):
...
class EOneDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> EOneCoordinatorData:
